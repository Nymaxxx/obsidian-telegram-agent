...
| [Web client spec](web-client-spec.md) | Android-first PWA workbench: browsable multi-session sidebar, share-sheet capture, voice, Web Push, visual diff/undo, dashboards — plus the exposure model behind Coolify + Authentik forward-auth |
