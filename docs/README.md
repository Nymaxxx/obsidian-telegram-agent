...
| [Bridge spec](bridge-spec.md) | Build specification for the new bridge: Takopi parity checklist, new capabilities (checkpoints/undo, budget guard, scheduler, skills), env contract, phased build plan |
